    ...
    <script type="text/javascript">
    	...
    	*/
    	...
    	function sendMsg(){
	    	...
	    	var url = "http://localhost:8081/cxf/ExportCServiceImpl";			//webService访问链接
	    	var requestBody = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:q0=\"http://impl.service.ssm.giao.com/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="id" id="id" value="11f83852-8811-417f-8d12-e6bb9b03670a"/></td>
	        </tr>
	        <tr>
