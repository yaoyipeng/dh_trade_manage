...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/factoryc/UpdateFactoryc','_self');">确定</a></li>
<li id="back"><a href="${ctx}/factoryc/findFactorycAll">返回</a></li>
</ul>
    </div>
</div>
</div>
