...
<head>
	...
	function addTRRecord(objId, exportProductId, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
		...
		oTD.innerHTML = "<input class=\"input\" type=\"checkbox\" name=\"del\" value=\""+exportProductId+"\"><input type=\"hidden\" name=\"mr_id\" value=\""+exportProductId+"\"><input class=\"input\" type=\"hidden\" id=\"mr_changed\" name=\"mr_changed\" >";
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/exportc/updateExportC','_self');">确定</a></li>
