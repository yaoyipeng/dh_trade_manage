...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/contractProductC/insertContractProductC','_self');">确定</a></li>
<li id="back"><a href="${ctx}/contractC/findContractCAll">返回</a></li>
</ul>
    </div>
</div>
</div>
	            ...
	            <td class="tableContent">
	            	<select name="factoryId" onchange="setFactoryName(this.options[this.selectedIndex].text);">
	            		...
	            		<c:forEach items="${factoryList}" var="f">
	            			<option value="${f.factoryId}">${f.fullName}</option>
	            		</c:forEach>
	            	</select>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.amount}</td>
		<td>
			<a href="${ctx}/contractProductC/goUpdateContractProductCById?contractProductId=${o.contractProductId}&contractId=${contractId}">修改</a>
			<a href="${ctx}/contractProductC/deleteContractProductCById?contractProductId=${o.contractProductId}&contractId=${contractId}">删除</a>
			<a href="${ctx}/extCproductC/findMultipleExtCproductCById?contractProductId=${o.contractProductId}">附件</a>
		</td>
	</tr>
	</c:forEach>
