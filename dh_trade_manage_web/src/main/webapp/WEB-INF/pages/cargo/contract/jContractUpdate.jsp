...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/contractC/updateContractC','_self');">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" style="height:120px;">${obj.request}</textarea></td>
