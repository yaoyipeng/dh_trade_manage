...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/extCproductC/insertExtCproductC','_self');">确定</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.amount}</td>
		<td>
			<a href="${ctx}/extCproductC/goUpdateExtCproductCById?extCproductId=${o.extCproductId}&contractProductId=${o.contractProductId}">[修改]</a>
			<a href="${ctx}/extCproductC/deleteExtCproductCById?extCproductId=${o.extCproductId}&contractProductId=${o.contractProductId}">[删除]</a>
		</td>
	</tr>
	</c:forEach>
