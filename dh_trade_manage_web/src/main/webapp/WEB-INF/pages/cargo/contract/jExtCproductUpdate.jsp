...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/extCproductC/updateExtCproductCById','_self');">确定</a></li>
<li id="back"><a href="${ctx}/extCproductC/findMultipleExtCproductCById?contractProductId=${obj.contractProductId}">返回</a></li>
</ul>
    </div>
</div>
</div>
